...
type Noop = () -> any
type MethodNameOrTrue = string | boolean
type CanAdd = Instance | RBXScriptConnection | any & ({Destroy: Noop} | {Disconnect: Noop}) | Noop
...
**--]]
function Janitor.__index:Add(Object: CanAdd, MethodName: MethodNameOrTrue?, Index: any?): CanAdd
	if Index then
		self:Remove(Index)
